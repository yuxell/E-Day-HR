...
namespace KD25_BitirmeProjesi.UI.MVC_Core.Areas.CompanyManager.Controllers
{
    ...
    public class SalaryAdvanceController : Controller
    {
        ...
        public SalaryAdvanceController(IHttpClientFactory httpClientFactory, HttpClient httpClient, IHttpContextAccessor httpContextAccessor, IConfiguration configuration)
        {
